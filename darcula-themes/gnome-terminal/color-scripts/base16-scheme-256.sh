...
[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="Base 16 Darcula 256"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="base-16-scheme-256"
[[ -z "$DCONF" ]] && DCONF=dconf
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#2B2B2B', '#79ABFF', '#A5C25C', '#A9B7C6', '#FFC66D', '#CC7832', '#629755', '#D8D8D8', '#808080', '#79ABFF', '#A5C25C', '#A9B7C6', '#FFC66D', '#CC7832', '#629755', '#F8F8F8']"
