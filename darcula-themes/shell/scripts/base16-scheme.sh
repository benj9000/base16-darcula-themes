...
color01="79/AB/FF" # Base 08 - Red
color02="A5/C2/5C" # Base 0B - Green
color03="A9/B7/C6" # Base 0A - Yellow
color04="FF/C6/6D" # Base 0D - Blue
...
color16="98/76/AA" # Base 09
color17="D2/52/52" # Base 0F
color18="32/32/32" # Base 01
color19="21/42/83" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pj 214283 # selection color
