...
-- Theme author: Matthias Brandt (github.com/PlusMinus0) based on Darcula theme by Konstantin Bulenkov (github.com/bulenkov/Darcula)
...
colors.base02 = 0x834221
colors.base03 = 0x808080
colors.base04 = 0xD0D0D0
colors.base05 = 0xD8D8D8
colors.base06 = 0xE8E8E8
colors.base07 = 0xF8F8F8
colors.base08 = 0xFFAB79
colors.base09 = 0xAA7698
colors.base0A = 0xC6B7A9
colors.base0B = 0x5CC2A5
colors.base0C = 0x559762
colors.base0D = 0x6DC6FF
colors.base0E = 0x3278CC
colors.base0F = 0x5252D2
