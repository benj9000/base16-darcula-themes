...
local base06 = "#E8E8E8" -- +++
local base07 = "#F8F8F8" -- ++++
local base08 = "#79ABFF" -- red
local base09 = "#9876AA" -- orange
local base0A = "#A9B7C6" -- yellow
local base0B = "#A5C25C" -- green
local base0C = "#629755" -- aqua/cyan
local base0D = "#FFC66D" -- blue
local base0E = "#CC7832" -- purple
local base0F = "#D25252" -- brown
